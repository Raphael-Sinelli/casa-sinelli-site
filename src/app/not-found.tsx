...
export default function NotFound() {
  return (
    <div className="max-w-xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
      <span className="mx-auto mb-6 flex w-16 h-16 items-center justify-center rounded-full rounded-bl-sm bg-jatoba text-cru font-serif italic font-semibold text-2xl">
        CS
      </span>
      <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-jatoba mb-3">
        Erro 404
      </p>
      ...
      <div className="mt-9 flex flex-col sm:flex-row gap-3.5 justify-center">
        <Link
          href="/catalogo"
          className="inline-flex items-center justify-center gap-2 bg-grafite hover:bg-grafite/85 text-cru font-semibold px-6 py-3.5 rounded-xl transition-colors focus-visible:outline-2 focus-visible:outline-vinho focus-visible:outline-offset-2"
        >
          Ver o catálogo
