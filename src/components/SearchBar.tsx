    ...
    <div className="relative">
      ...
      {valor && (
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 text-grafite/40 hover:text-grafite transition-colors focus-visible:outline-2 focus-visible:outline-musgo rounded-sm"
        >
